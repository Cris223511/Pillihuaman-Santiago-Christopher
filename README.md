...
<i><p aligh="justify">
- CompuSac es un proyecto que voy llevando meses de trabajo en su entorno web, donde hice la práctica de distintos lenguajes de programación.
- Lo que se muestra en este repositorio es solo la página principal de mi proyecto CompuSac.
- En este repositorio se aplicó el HTML, CSS, JS y Boostrap. </p></i>
